...
<html>
	...
	<body>
		<div class="container">	
				...
				<g:hasErrors bean="${intervalInstance}">
				<bootstrap:alert class="alert-danger">
				<ul>
					<g:eachError bean="${intervalInstance}" var="error">
					...
					<g:form class="form" action="edit" id="${intervalInstance?.id}" >
						<g:hiddenField name="version" value="${intervalInstance?.version}" />						
							<f:all bean="intervalInstance"/>
