	...
	<body>
		<div class="container">	
				...
				<ul>
					...
					<g:form class="form" action="edit" id="${boardTemplateInstance?.id}" >
						<g:hiddenField name="version" value="${boardTemplateInstance?.version}" />						
							...
							<g:render template="/boardTemplate/channel_list"/>								
