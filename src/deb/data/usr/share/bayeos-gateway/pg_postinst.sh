...
flyway(){
	java -Djava.security.egd=file:/dev/../dev/urandom -cp $INSTALLDIR/lib/*:$INSTALLDIR/drivers/* org.flywaydb.commandline.Main -url=jdbc:postgresql://localhost/xbee -driver=org.postgresql.Driver -user=xbee -password=0b64debf8fae4239a7ca845f39878a3d -locations=filesystem:$INSTALLDIR/sql $1
}
# fix backports 
flyway repair
flyway migrate
